...
import org.usfirst.frc4456.mechstorm2016.OI;
...
/*
   ...
   */
	...
	// TODO Auto-generated method stub
		singleArm.set(ARM_POSITIONS[index]);
	}
	...
	{
		return Robot.oi.joystick.getRawAxis(3) - Robot.oi.joystick.getRawAxis(2);
	}
	public void cycle(){
	//NUDGE
	// Left and right triggers move the hooks down and up
		int nudgeFactor = 2;
		double talonSetValue = singleArm.getSetpoint() + (nudgeFactor * getAxisTriggers());
		singleArm.set(talonSetValue);
