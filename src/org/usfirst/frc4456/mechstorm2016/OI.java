...
public class OI {
    ...
    public OI(Robot robot) {
        ...
        //startButton.toggleWhenActive(new Auto1());
       ...
       // rightStick = new JoystickButton(joystick, 10);
        //rightStick.whileHeld(new MoveArmStrong());
        //leftStick = new JoystickButton(joystick, 9);
        //leftStick.whileHeld(new MoveArmStrong());
        ...
        */
        ...
        SmartDashboard.putNumber("Encoder", singleArm.get());
        SmartDashboard.putNumber("GetSetPoint", singleArm.getSetpoint());
