...
import org.usfirst.frc.team4456.robot.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        aButton.whileHeld(new secondBack());
        xButton = new JoystickButton(joystick, 3);
        xButton.whileHeld(new secondForward());
        ...
        SmartDashboard.putData("secondForward", new secondForward());
        SmartDashboard.putData("secondBack", new secondBack());
